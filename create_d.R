...
d = d[,c("EventId", "Weight", "Label", "Model_No", "cvGroup"
    ,"DER_deltaeta_jet_jet", "DER_mass_jet_jet", "DER_prodeta_jet_jet", "DER_lep_eta_centrality", "PRI_jet_subleading_pt", "PRI_jet_subleading_eta", "sin_PRI_jet_subleading_phi", "cos_PRI_jet_subleading_phi"
    ,"PRI_jet_leading_pt", "PRI_jet_leading_eta", "sin_PRI_jet_leading_phi", "cos_PRI_jet_leading_phi"
    ,"DER_mass_MMC"
    ,"DER_mass_transverse_met_lep", "DER_mass_vis", "DER_pt_h", "DER_deltar_tau_lep", "DER_pt_tot", "DER_sum_pt", "DER_pt_ratio_lep_tau", "DER_met_phi_centrality", "PRI_tau_pt", "PRI_tau_eta","PRI_lep_pt", "PRI_lep_eta", "PRI_met", "PRI_met_sumet", "PRI_jet_num", "PRI_jet_all_pt", "sin_PRI_tau_phi", "cos_PRI_tau_phi", "sin_PRI_lep_phi", "cos_PRI_lep_phi", "sin_PRI_met_phi", "cos_PRI_met_phi")]
